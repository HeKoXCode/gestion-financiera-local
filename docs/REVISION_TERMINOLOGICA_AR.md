...
- exactas respecto del cálculo que realiza el programa;
...
| --- | --- | --- |
| Quincenal | Cada 2 semanas | El programa genera vencimientos cada 14 días. “Quincenal” puede interpretarse como cada 15 días. |
...
| Clientes morosos | Clientes con pagos atrasados | Describe la situación concreta sin etiquetar a la persona. |
...
| Sincronizado localmente | Datos guardados en este equipo | No existe sincronización con internet; el nuevo texto describe el funcionamiento real. |
...
- `Otro resultado` abre el formulario para registrar ausencia, promesa de pago
  u otra observación.
- El panel inicial usa `Abrir programa` y `Cerrar y respaldar`, los mismos
